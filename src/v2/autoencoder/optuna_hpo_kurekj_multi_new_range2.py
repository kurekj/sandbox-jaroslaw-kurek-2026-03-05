...
def objective_partial(
    ...
    learning_rate = trial.suggest_float("learning_rate", 1.5e-3, 3.5e-3, log=True)

    #weight_decay = trial.suggest_float("weight_decay", 1e-8, 1e-3, log=True)
    weight_decay = trial.suggest_float("weight_decay", 5e-7, 3e-5, log=True)
    ...
    dropout = trial.suggest_float("dropout", 0.0, 0.03)

    #leaky_relu_slope = trial.suggest_float("leaky_relu_slope", 0.00, 0.2)
    leaky_relu_slope = trial.suggest_float("leaky_relu_slope", 0.14, 0.20)
