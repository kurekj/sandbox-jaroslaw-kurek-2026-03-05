...
def business_score_breakdown(
    ...
    gamma = params.gamma
    base_component = q_norm ** gamma  # q^gamma
    ...
    term_profit = beta * r_raw
    term_gap = eta * g_raw
    term_fairness = params.mu * m_raw
    term_vip = params.nu * v_raw
    ...
    # --- cap penalty ---
    cap_ratio_raw = candidate.cap_ratio
